    ...
    <header className="glass fixed inset-x-0 top-0 z-50 border-b border-line">
      <nav className="mx-auto flex h-14 max-w-6xl items-center justify-between px-5">
        <a href="#top" className="flex items-center gap-2.5 font-semibold tracking-tight">
          <Mark />
          <span>
            Synthetic Data <span className="text-ember">Forge</span>
          </span>
        </a>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="#console"
            className="rounded-md bg-ember px-3.5 py-1.5 text-sm font-semibold text-bg transition-all hover:bg-ember-hot hover:shadow-[0_0_24px_rgba(251,146,60,0.35)]"
          >
            Start a run
          </a>
        </div>
